...
## 담당 업무
- 데이터 수집 및 DB 관리 : 카카오맵 API를 활용한 식당 데이터 수집 및 MongoDB를 통한 DB 관리
- 머신러닝을 활용한 추천 시스템 구현 : 사용자 협업 필터링 알고리즘을 활용한 추천 시스템 구현, FAST API를 사용한 API 구현 및 문서화
- 서버 API 구현 : Spring Boot를 사용한 API 구현
<br>
