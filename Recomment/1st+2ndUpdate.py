...
def firstRecommendUpdate():
    groupNamss = ["A","B","C","D","E"]
    for groupName in groupNamss:
...
def secondRecommendUpdate():
    all_users = user_table.find({})
...
print("start")
firstRecommendUpdate()
#secondRecommendUpdate()
print("end")
